...
public struct PublishCommandOptions: Equatable, Sendable {
    public var manifestPath: String
    public var channel: String
    public var showHelp: Bool

    public init(manifestPath: String, channel: String, showHelp: Bool) {
        self.manifestPath = manifestPath
        self.channel = channel
        self.showHelp = showHelp
    }

    public static var defaults: PublishCommandOptions {
        PublishCommandOptions(manifestPath: "", channel: "", showHelp: false)
    }

    public static func parse(arguments: [String]) throws -> PublishCommandOptions {
        ...
        if !options.showHelp {
            ...
            let channel = options.channel.trimmingCharacters(in: .whitespacesAndNewlines)
            if channel.isEmpty {
                throw BatchError.missingRequiredOption("--channel")
            }
        }
